...
const CharityCardEl = styled.article`
    position: relative;
    display: flex;
...
export default function CharityCard({ item }) {
    const {Id, Badge, ImageUrl, Edition, Stock, Title, Price, Avatar, Author, Likes} = item;
    return <CharityCardEl>
        <Card>
            ...
            <InfoSection>
                <TSection>
                    <EditionEl>{Edition} {Edition > 1 ? "Editions" : "Edition"} Minted</EditionEl>
